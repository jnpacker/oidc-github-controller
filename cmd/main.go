...
import (
	...
	controllers "github.com/jnpacker/oidc-github-controller/controller"
)
...
func init() {
	...
	utilruntime.Must(managedclusterv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a2d4a57a.odic.open-cluster-management.io",
	...
	if err = (&controllers.OIDCGithubManagedClusterReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "oidc-github")
		os.Exit(1)
	}
	// +kubebuilder:scaffold:builder
